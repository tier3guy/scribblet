...
interface IShareTeamLinkComponent {
    setCollaboratorAdded: React.Dispatch<React.SetStateAction<boolean>>;
}
...
function ShareTeamLinkComponent({ setCollaboratorAdded }: IShareTeamLinkComponent) {
    ...
    return (
        <div>
            ...
            <div className='mt-4 border-t w-full pt-4 text-sm'>
                <PrimaryButton
                    label='Add a new Collaborator'
                    className='text-sm bg-orange-500 hover:bg-orange-600 text-gray-100 w-full'
                    onClick={() => {
